...
export default function HeaderComp({ colorBgContainer }: Iprops) {
  ...
  return (
    <Header style={{ height: '60px', padding: 0, background: colorBgContainer }}>
      <div className='h-full flex justify-end items-center pr-[8px]'>
        ...
        <img src={userLogo} className='w-[54px] h-[48px] rounded-[50%] border-[#ccc] border-solid border-[1px]'></img>
      </div>
    </Header>
  )
}
